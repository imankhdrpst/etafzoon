...
public class AuthResource<T> {
    ...
    public static <T> AuthResource<T> phoneNumberValid(@Nullable T data) {
        return new AuthResource<>(AuthStatus.PHONE_NUMBER_VALID, data, null);
    }
    ...
    public enum AuthStatus { PHONE_NUMBER_VALID, AUTHENTICATED, ERROR, LOADING, NOT_AUTHENTICATED, PROFILE_FILLED}
